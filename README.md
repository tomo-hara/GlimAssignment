...
스레드를 사용하며 UI 설계에 대한 이해 (예. 메시지 시스템<sup>[2](#footnote_2)</sup>) 및 몇몇 함수의 특징에 대한 학습도 개인적으로 유익했습니다.
...
- Dec 06, 2025 (ebf1ce3) : 추가 기능 7. ListBox 추가 및 스레드 예외처리
- Dec 10, 2025 (xxxxxxx) : 스레드 임계영역 코드 작성
- - -
추가해볼만한 기능
